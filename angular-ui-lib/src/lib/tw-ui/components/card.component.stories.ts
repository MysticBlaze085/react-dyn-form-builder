...
@Component({
  ...
  template: `
    <adk-card>
      <h5 class="adk-card-header block mb-2 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
        UI/UX Review Check
      </h5>
      <p class="adk-card-content block font-sans text-base antialiased font-light leading-relaxed text-inherit">Card content goes here</p>
      <button
