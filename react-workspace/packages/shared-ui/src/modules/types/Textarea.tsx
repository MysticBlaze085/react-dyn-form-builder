...
// const Textarea = ({ handler, touched, hasError, meta: { label, placeholder, classes } }) => {
...
export function TextareaFormControl({ handler, meta: { label, value, placeholder, required } }) {
