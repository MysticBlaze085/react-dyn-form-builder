...
const TableSettingsDialog = () => {
    ...
    return (
        <>
            <ButtonDefault onClick={handleOpen} variant="gradient">
                Open Dialog
                <Cog8ToothIcon />
            </ButtonDefault>
            <Dialog
            ...
            >
                ...
                <DialogBody>
                    ...
                    twenty five years of blood sweat and tears, and I&apos;m never giving up, I&apos;m just getting started. I&apos;m up to
                    something. Fan luv.
                </DialogBody>
                <DialogFooter>
